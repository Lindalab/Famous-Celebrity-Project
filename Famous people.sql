...
industry_id tinyint(4) primary key,
...
celebrity_id tinyint(4) primary key, 
...
profession ENUM ("Actor", "Singer", "Both"));
 ...
 CREATE TABLE  movies( 
 movie_id tinyint(4) primary Key, 
title VARCHAR (30), 
release_year YEAR, 
genre VARCHAR (30)
);
...
CREATE TABLE music(
music_id tinyint(4) Primary Key, 
title VARCHAR(25), 
release_year YEAR, 
genre VARCHAR (25),
...
CREATE TABLE awards(
award_id tinyint(4) Primary Key AUTO_INCREMENT,
celebrity_id tinyint(4),
number_of_awards int(5),
networth decimal(20,2),
rating tinyint(4),
industry_id tinyint(4),
...
-- Bollywood
(21,"Alia","Blatt",'1993-03-15',"Female","Indian","Both"),
...
Select number_of_awards from awards order by number_of_awards;
*/